...
_employee_db = 'database/employees.json'
_credentials_db = 'database/credentials.json'

_employees = Employees(_employee_db)

_credentials = Credentials(_credentials_db)
...
class Employee(Resource):
    ...
    def get(self, name):
        ...
        if employee is None:
            return {'message': "User '{}' not found".format(name)}, 404 # TODO: wrong credentials
